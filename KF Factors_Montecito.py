...
# Also plot the grid boundaries for verification
fig, ax = plt.subplots(figsize=(12, 12))
gdf.boundary.plot(ax=ax, color='black')
plt.title('Grid Boundaries')
plt.show()

# Plot the individual points to ensure coordinates are correct
fig, ax = plt.subplots(figsize=(12, 12))
...
raster_path = "D:\\Masters\\Thesis Data\\USGS EE Burn Ratio\\Thomas Fire\\Before\\LC08_L2SP_042036_20171123_20200902_02_T1_SR_B5.tif"
with rasterio.open(raster_path) as src:
    print(src.crs)
...
pre_fire_nir_clipped, pre_fire_transform = clip_raster_to_grid(pre_fire_b5, grid_bounds)
print(pre_fire_transform)
#%%
import matplotlib.pyplot as plt
import rasterio.plot

# Plot raster
with rasterio.open(pre_fire_b5) as src:
    fig, ax = plt.subplots(figsize=(10, 10))
    rasterio.plot.show(src, ax=ax, title="Raster and Grid Points")
